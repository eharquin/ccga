...
| **Center as a point** | `conic_center_point` **[num]** = $M_3^{-1}[0,0,1]^\top$ (pole of $L_\infty$) | finite point; **ideal** (point at infinity) for a parabola |
...
| **Discriminant** | `conic_discriminant(A,B,C)` = $C^2-4AB$ | type |
| **Degenerate?** | `conic_is_degenerate` **[num]** | $\det M_3\approx0$ (line pair / point) |

The center of a parabola is at infinity (the pole of $L_\infty$ has $w=0$) — an ideal
